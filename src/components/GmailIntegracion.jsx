...
export default function GmailIntegracion({ onImportComplete }) {
  ...
  if (!conectado) return (
    <div style={{ background:'#fff', border:'1px solid #e2e8f0', borderRadius:16, padding:32, textAlign:'center' }}>
      ...
      <div style={{ fontSize:17, fontWeight:700, color:'#2F5D48', marginBottom:8, ...f }}>Conectar Gmail</div>
  ...
  return (
    <div style={{ background:'#fff', border:'1px solid #e2e8f0', borderRadius:16, padding:28 }}>
      ...
      <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:24 }}>
        <div>
          <div style={{ fontSize:16, fontWeight:700, color:'#2F5D48', ...f }}>📧 Gmail conectado</div>
              ...
              <div key={i} style={{ background:'#fff', border:'1px solid #fca5a5', borderRadius:10, padding:'12px 16px', display:'flex', justifyContent:'space-between', alignItems:'flex-start', gap:12, flexWrap:'wrap' }}>
                <div style={{ flex:1, minWidth:220 }}>
                  <div style={{ display:'flex', gap:8, alignItems:'center', marginBottom:4, flexWrap:'wrap' }}>
                    <span style={{ fontSize:12, fontWeight:600, color:'#2F5D48', ...f }}>{item.tipoDiligencia}</span>
                  ...
                  <div style={{ fontSize:12, color:'#64748b', ...f }}>
                    RUC <span style={{ fontFamily:'monospace', fontWeight:600, color:'#2F5D48' }}>{item.ruc}</span>
              ...
              <div key={i} style={{ background:'#fff', border:'1px solid #a7f3d0', borderRadius:10, padding:'12px 16px', display:'flex', justifyContent:'space-between', alignItems:'flex-start', gap:12 }}>
                <div style={{ flex:1 }}>
                  <div style={{ display:'flex', gap:8, alignItems:'center', marginBottom:4, flexWrap:'wrap' }}>
                    ...
                    <span style={{ fontSize:12, fontWeight:600, color:'#2F5D48', ...f }}>{item.tipo}</span>
                  </div>
                  <div style={{ fontSize:12, color:'#64748b', ...f }}>
                    RUC <span style={{ fontFamily:'monospace', fontWeight:600, color:'#2F5D48' }}>{item.ruc}</span>
                    {item.imputado && <span style={{ marginLeft:8 }}>· {item.imputado.split('|')[0]}</span>}
          ...
          <div style={{ display:'flex', flexDirection:'column', gap:6 }}>
            {errores.map((e, i) => (
              <div key={i} style={{ background:'#fff', border:'1px solid #fecaca', borderRadius:8, padding:'10px 14px' }}>
                <div style={{ fontSize:12, fontWeight:600, color:'#2F5D48', marginBottom:2, ...f }}>{e.asunto}</div>
          ...
          <div style={{ display:'flex', flexDirection:'column', gap:6 }}>
            {sinCausa.map((n, i) => (
              <div key={i} style={{ background:'#fff', border:'1px solid #e2e8f0', borderRadius:8, padding:'10px 14px', display:'flex', justifyContent:'space-between', alignItems:'center' }}>
                <div>
                  <div style={{ fontSize:12, fontWeight:600, color:'#2F5D48', ...f }}>{n.asunto}</div>
