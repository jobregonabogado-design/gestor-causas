...
export default function Dashboard({ session }) {
  ...
  return(
    <div style={{background:'#f8fafc',minHeight:'100vh',...f}}>
      ...
      {/* MODAL NUEVA CAUSA */}
      {showNuevaCausa&&(
        <div style={{position:'fixed',inset:0,background:'rgba(15,23,42,0.5)',display:'flex',alignItems:'center',justifyContent:'center',zIndex:1001}} onClick={e=>e.target===e.currentTarget&&setShowNuevaCausa(false)}>
